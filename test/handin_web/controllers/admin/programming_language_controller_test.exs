defmodule HandinWeb.Admin.ProgrammingLanguageControllerTest do
  ...
  describe "edit programming_language" do
    ...
    test "renders form for editing chosen programming_language", %{conn: conn, programming_language: programming_language} do
  ...
  describe "update programming_language" do
    ...
    test "redirects when data is valid", %{conn: conn, programming_language: programming_language} do
      conn = put conn, ~p"/admin/programming_languages/#{programming_language}", programming_language: @update_attrs
    ...
    test "renders errors when data is invalid", %{conn: conn, programming_language: programming_language} do
      conn = put conn, ~p"/admin/programming_languages/#{programming_language}", programming_language: @invalid_attrs
      assert html_response(conn, 200) =~ "Edit Programming language"
    end
  end
  ...
  describe "delete programming_language" do
    ...
    test "deletes chosen programming_language", %{conn: conn, programming_language: programming_language} do
