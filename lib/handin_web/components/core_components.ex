defmodule HandinWeb.CoreComponents do
  ...
  defp breadcrumb_position(index, _size) when index == 0, do: "first"
  defp breadcrumb_position(index, size) when index == size, do: "last"
  defp breadcrumb_position(_, _), do: ""

  attr :position, :string
  attr :text, :string, required: true
  attr :href, :string, required: true

  defp breadcrumb_item(assigns) when assigns.position == "first" do
    ~H"""
  ...
  defp breadcrumb_item(assigns) when assigns.position == "last" do
    ~H"""
